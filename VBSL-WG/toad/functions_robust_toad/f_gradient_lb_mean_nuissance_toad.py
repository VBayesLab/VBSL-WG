...
from f_mean_adjust_ss_toad import summary_statistics, mean_adjustment_summary_statistics  
...
def mean_adjustment_unbiased_log_likelihood(gs_adjusted_theta, n_datasets, num_coeffs, num_latent, actual_summary_statistics):
    mean_adj_ss = mean_adjustment_summary_statistics(gs_adjusted_theta, n_datasets, num_coeffs, num_latent, actual_summary_statistics)
...
def fun_gradient_lb(s, theta_samples, mu_q, l_q, c, n_datasets, num_coeffs, num_latent, actual_summary_statistics):
    ...
    # Find gradient of LB
    llh = mean_adjustment_unbiased_log_likelihood(adjusted_theta_q, n_datasets, num_coeffs, num_latent, actual_summary_statistics)
